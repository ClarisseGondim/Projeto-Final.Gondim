...
def cadastrar_aluno(alunos, matricula, nome):
    """
    Adicionar um novo aluno e verificar se a matrícula já existe.
    """
...
def matricular_aluno(alunos, disciplinas, matricula, codigo):
    """
    Matricular aluno em uma disciplina e impedir a matrícula duplicada.
    """
...
def lancar_nota(alunos, disciplinas, codigo, nota, matricula):
    """
    Lançar nota para um aluno em uma disciplina específica.
    """
    if matricula not in alunos:
        print("Erro: Aluno não encontrado.")
    elif codigo not in disciplinas:
...
def listar_disciplinas(disciplinas):
    """
    Exibir a lista de todas as disciplinas cadastradas.
    """
    if not disciplinas:
...
def listar_alunos_disciplina(disciplinas, alunos, codigo):
    """
    Listar todos os alunos matriculados em uma disciplina específica.
    """
...
def exibir_boletim(alunos, disciplinas, matricula):
    """
    Exibir boletim de aluno, com as disciplinas, notas, médias e status de aprovação.
    """
    if matricula not in alunos:
        print("Erro: Aluno não encontrado.")
        return
...
def calcular_media_geral(alunos, matricula):
    """
    Calcular a média geral de todas as notas de um aluno.
    """
    if matricula not in alunos:
        print("Erro: Aluno não encontrado.")
        return None
...
def aprovado_em_todas(alunos, matricula):
    """
    Verificar se um aluno foi aprovado em todas as disciplinas.
    """
    if matricula not in alunos:
        print("Erro: Aluno não encontrado.")
        return False
...
def alterar_nome_aluno(alunos, matricula, novo_nome):
    """
    Alterar nome de aluno a partir de sua matrícula.
    """
    if matricula not in alunos:
        print("Erro: Aluno não encontrado.")
    else:
...
def alterar_nome_disciplina(disciplinas, codigo, novo_nome):
    """
    Alterar o nome de uma disciplina a partir de seu código.
    """
    if codigo not in disciplinas:
        print("Erro: Disciplina não encontrada.")
    else:
...
def excluir_aluno(alunos, disciplinas, matricula):
    """
    Excluir um aluno e remover sua matrícula das disciplinas em que estiver.
    """
    if matricula not in alunos:
        print("Erro: Aluno não encontrado.")
    else:
